...
- **FW**: Default DROP policies, strict `nftables` attack mitigation, zone isolation. *Exception: Unidirectional LAN -> IoT/Media pinhole (TCP/UDP 8008, 8009, 8443) and mDNS Input (UDP 5353) allowed for Chromecast.*
